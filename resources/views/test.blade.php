            ...
            <div class="employee-card p-2">
                <div class="d-flex justify-content-end">
                    <a href="#" type="button" id="{{auth()->user()->employee->id ?? 'n/a'}}" class="btn-view editIcon" style="background-color: transparent; box-shadow: none;" data-tippy-content="Edit Profile" data-tippy-arrow="false" data-bs-toggle="modal" data-bs-target="#EditEmployee">
                        <i class="bx bxs-edit fs-5" style="color:#bc3d4f"></i>
                    </a>
                </div>
                    {{-- pic --}}
                <div class="p-2">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        {{-- <a href="#" type="button" id="btnForm1" class="btn-view editIcon m-0 p-0" data-tippy-content="Change Password" data-tippy-arrow="false" data-bs-toggle="modal" data-bs-target="#EditUser">
                            <i class="bx bx-key"></i>
                        </a>
                        <a href="#" onclick="scrollToForm()" type="button" id="btnForm2" class="btn-view editIcon m-0 p-0" data-tippy-content="View Payslip" data-tippy-arrow="false" data-bs-toggle="modal" data-bs-target="#EditUser">
                            <i class="bx bx-money-withdraw"></i>
                        </a>
                        <a href="#" type="button" id="btnForm3" class="btn-view editIcon m-0 p-0" data-tippy-content="Edit Profile Pic" data-tippy-arrow="false" data-bs-toggle="modal" data-bs-target="#EditUser">
